package com.example.thepagingapp2.adapter;
...
import com.example.thepagingapp2.databinding.SingleMovieItemBinding;
import com.example.thepagingapp2.model.Movie;
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        if ( currentMovie != null) {
            glide.load("https://image.tmdb.org/t/p/w500" + currentMovie.getPosterPath())
                    .into(holder.movieItemBinding.ivMovie);
